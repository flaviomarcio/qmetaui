...
{    
    ...
    if(u.isEmpty(v))
        return false;
    else if (vStr.length() != 11)
        return false;
    else if (vStr.toLongLong()<=0)
        return false;
    else {

        static auto vList=QStringList() <<QStringLiteral("00000000000")
                                        <<QStringLiteral("11111111111")
                                        <<QStringLiteral("22222222222")
                                        <<QStringLiteral("33333333333")
                                        <<QStringLiteral("44444444444")
                                        <<QStringLiteral("55555555555")
                                        <<QStringLiteral("66666666666")
                                        <<QStringLiteral("77777777777")
                                        <<QStringLiteral("88888888888")
...
bool MUValidationUtilPTB::isCNPJ(const QVariant &v)
{
    ...
    if(u.isEmpty(v))
        ...
        static auto vList=QStringList()
                <<QStringLiteral("00000000000000")
               <<QStringLiteral("11111111111111")
              <<QStringLiteral("22222222222222")
             <<QStringLiteral("33333333333333")
            <<QStringLiteral("44444444444444")
           <<QStringLiteral("55555555555555")
          <<QStringLiteral("66666666666666")
         <<QStringLiteral("77777777777777")
        <<QStringLiteral("88888888888888")
