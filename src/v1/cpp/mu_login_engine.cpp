...
Q_GLOBAL_STATIC(MULoginEngine,muLoginEngine)
...
MULoginEngine::MULoginEngine(QObject *parent) : QObject(parent)
{
    ...
    QObject::connect(this, &MULoginEngine::loginStarted,this, &MULoginEngine::loginMessage);
    QObject::connect(this, &MULoginEngine::loginSuccessful,this, &MULoginEngine::loginMessage);
    QObject::connect(this, &MULoginEngine::loginUnsuccessful,this, &MULoginEngine::loginMessage);
    QObject::connect(this, &MULoginEngine::loginMatch,this, &MULoginEngine::loginMessage);
    QObject::connect(this, &MULoginEngine::loginError,this, &MULoginEngine::loginMessage);
    QObject::connect(this, &MULoginEngine::loginFail,this, &MULoginEngine::loginMessage);
    QObject::connect(this, &MULoginEngine::loginCodeSent,this, &MULoginEngine::loginMessage);
}
...
bool MULoginEngine::account_match(const QVariant &account)
{
    ...
    QVariantHash vHash;
    vHash.insert(qsl("hsh_account"), p.var.hsh_account());
    p.request().setBody(vHash);
...
bool MULoginEngine::account_session_verify()
{
    ...
    p.request().setBody(hash);
    p.request().setAuthBearer(session.hsh_md5());
    auto onOk=[this](const MURequest*){
