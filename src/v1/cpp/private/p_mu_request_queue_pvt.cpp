...
MURequestQueuePvt::MURequestQueuePvt(QObject *object):QObject(nullptr)
{
    Q_UNUSED(object)
}
...
void MURequestQueuePvt::onRequestFinish(MURequest *request, const QVariantMap &vResponse)
{
    bool contains=false;
    {//scope mutex
        QMutexLocker locker(&this->mutex);
