...
public:
    ...
    //!
    //! \brief account_autenticate_password
    //! \param account
    //! \param password
    //! \return
    //!
    ...
    //!
    //! \brief account_autenticate_code
    //! \param account
    //! \param code
    //! \return
    //!
